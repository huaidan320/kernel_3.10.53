...
//#define ESAI_xFCR_xE_SHIFT	3
//#define ESAI_xFCR_TE_WIDTH	5
//#define ESAI_xFCR_RE_WIDTH	3

#define ESAI_xFCR_RE_WIDTH	3
#define ESAI_xFCR_RE_SHIFT	3
...
#define ESAI_xFCR_RE_MASK	(((1 << ESAI_xFCR_RE_WIDTH) - 1) << ESAI_xFCR_RE_SHIFT)
#define ESAI_xFCR_RE(x) 	((ESAI_xFCR_RE_MASK >> (ESAI_xFCR_RE_WIDTH - x)) & ESAI_xFCR_RE_MASK)
...
//#define ESAI_xCR_TE_WIDTH	5
//#define ESAI_xCR_xE_SHIFT	1
//#define ESAI_xCR_RE_WIDTH 3

#define ESAI_xCR_RE_WIDTH	3
#define ESAI_xCR_RE_SHIFT	1
...
#define ESAI_xCR_RE_MASK	(((1 << ESAI_xCR_RE_WIDTH) - 1) << ESAI_xCR_RE_SHIFT)
