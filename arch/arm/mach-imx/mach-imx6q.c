	...
	if (!IS_ERR(gpr)) {
		if (of_machine_is_compatible("fsl,imx6q-sabresd") ||
		 ...
		 //	 regmap_update_bits(gpr, IOMUXC_GPR13, 0x3F, 0x0C);
		      regmap_update_bits(gpr, IOMUXC_GPR13, 0x3F, 0x20);	 // config CSI1 for IPU CSI1;   IPU-CSI0:000 miip-csi2 virtual channel0
		      														                               // IPU-CSI1: 100 parallel interface
...
#if 0
	regmap_read(gpr,IOMUXC_GPR1,  &val);	
	printk("--------%s %d GPR1 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
	regmap_read(gpr,IOMUXC_GPR2,  &val);	
	printk("--------%s %d GPR2 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
	regmap_read(gpr,IOMUXC_GPR3,  &val);	
	printk("--------%s %d GPR3 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
	regmap_read(gpr,IOMUXC_GPR4,  &val);	
	printk("--------%s %d GPR4 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
	regmap_read(gpr,IOMUXC_GPR5,  &val);	
	printk("--------%s %d GPR5 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
	regmap_read(gpr,IOMUXC_GPR6,  &val);	
	printk("--------%s %d GPR6 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
	regmap_read(gpr,IOMUXC_GPR7,  &val);	
	printk("--------%s %d GPR7 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
	regmap_read(gpr,IOMUXC_GPR8,  &val);	
	printk("--------%s %d GPR8 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
	regmap_read(gpr,IOMUXC_GPR9,  &val);	
	printk("--------%s %d GPR9 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
	regmap_read(gpr,IOMUXC_GPR10,  &val);	
	printk("-------%s %d GPR10 = 0x%08x------\n", __FUNCTION__, __LINE__, val);	
	regmap_read(gpr,IOMUXC_GPR11,  &val);	
	printk("-------%s %d GPR11 = 0x%08x------\n", __FUNCTION__, __LINE__, val);	
	regmap_read(gpr,IOMUXC_GPR12,  &val);	
	printk("-------%s %d GPR12 = 0x%08x------\n", __FUNCTION__, __LINE__, val);		
	regmap_read(gpr,IOMUXC_GPR13,  &val);	
	printk("-------%s %d GPR13 = 0x%08x------\n", __FUNCTION__, __LINE__, val);
#endif	
}
