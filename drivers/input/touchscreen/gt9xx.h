...
// ---------------------------------------------
#define GTP_RST_PORT    IMX_GPIO_NR(6,14)
#define GTP_INT_PORT    IMX_GPIO_NR(5,11)
...
#if GTP_CUSTOM_CFG
  #define GTP_MAX_HEIGHT    1600//  800
