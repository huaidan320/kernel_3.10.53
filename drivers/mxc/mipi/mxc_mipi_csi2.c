...
static void dump_mipi_register(void)
{
       printk(KERN_DEBUG "==============================\n");
	printk(KERN_DEBUG "---MIPI_CSI2_VERSION        =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_VERSION));
	printk(KERN_DEBUG "---MIPI_CSI2_N_LANES        =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_N_LANES));
	printk(KERN_DEBUG "---MIPI_CSI2_PHY_SHUTDOWNZ  =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_PHY_SHUTDOWNZ));
	printk(KERN_DEBUG "---MIPI_CSI2_DPHY_RSTZ      =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_DPHY_RSTZ));
	printk(KERN_DEBUG "---MIPI_CSI2_CSI2_RESETN    =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_CSI2_RESETN));	
	printk(KERN_DEBUG "---MIPI_CSI2_PHY_STATE      =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_PHY_STATE));	
	printk(KERN_DEBUG "---MIPI_CSI2_DATA_IDS_1     =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_DATA_IDS_1));	
	printk(KERN_DEBUG "---MIPI_CSI2_DATA_IDS_2     =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_DATA_IDS_2));
	printk(KERN_DEBUG "---MIPI_CSI2_ERR1           =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_ERR1));	
	printk(KERN_DEBUG "---MIPI_CSI2_ERR2           =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_ERR2));
	printk(KERN_DEBUG "---MIPI_CSI2_MASK1          =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_MASK1));	
	printk(KERN_DEBUG "---MIPI_CSI2_MASK2          =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_MASK2));	
	printk(KERN_DEBUG "---MIPI_CSI2_PHY_TST_CTRL0  =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_PHY_TST_CTRL0));
	printk(KERN_DEBUG "---MIPI_CSI2_PHY_TST_CTRL1  =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_PHY_TST_CTRL1));	
	printk(KERN_DEBUG "---MIPI_CSI2_SFT_RESET      =  %.8x-----\n", mipi_csi2_read(gmipi_csi2, MIPI_CSI2_SFT_RESET));	
	printk(KERN_DEBUG "==============================\n");
}
...
//		printk("---%s  cfg_clk rate = %ld---\n", __FUNCTION__,  clk_get_rate( info->cfg_clk));
//		printk("---%s  dphy_clk rate = %ld---\n", __FUNCTION__,  clk_get_rate( info->dphy_clk));
	} else
...
{
//	printk("---%s  pixel_clk rate = %ld---\n", __FUNCTION__,  clk_get_rate( info->pixel_clk));
...
//	mipi_csi2_write(info, 0x00000014, MIPI_CSI2_PHY_TST_CTRL1);
	mipi_csi2_write(info, 0x0000002a, MIPI_CSI2_PHY_TST_CTRL1);  // mipi clock 335  pixel clock = 1920*1080*30*1*1.35   
	mipi_csi2_write(info, 0x00000002, MIPI_CSI2_PHY_TST_CTRL0);
	mipi_csi2_write(info, 0x00000000, MIPI_CSI2_PHY_TST_CTRL0);

//	mipi_csi2_write(info, 0x0000002a, MIPI_CSI2_DATA_IDS_1);  //jacky
...
//	printk("  --gmipi_csi2->cfg_clk->rate        = %ld-- \n", clk_get_rate(gmipi_csi2->cfg_clk));
//	printk("  --gmipi_csi2->dphy_clk->rate     = %ld-- \n", clk_get_rate(gmipi_csi2->dphy_clk));
//	printk("  --gmipi_csi2->pixel_clk->rate      = %ld-- \n", clk_get_rate(gmipi_csi2->pixel_clk));
